...
public class Player {
     ...
     */
    public Player(int playerID, String playerName, String countryName, String careerSpan, int matchesPlayed, 
    ...
    /**
     * The method which returns the players ID number.
    ...
    {
        return getPlayerID() + " | " + getPlayerName() + " | " + getCountryName() + " | Career Span: " + calcCareerSpan() + " years | " 
